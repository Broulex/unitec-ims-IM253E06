...
public class LibrosDbContext
{
    ...
    public List<IM253E06Libro> List()
    {
        var libros = new List<IM253E06Libro>();
        var connection = new SqlConnection(_connectionString);
        var command = new SqlCommand("SELECT [Id],[Autor],[Editorial],[ISBN],[Foto] FROM IM253E06Libro", connection);
        try
        {
            connection.Open();
    ...
    public IM253E06Libro Details(Guid id)
    {
        var libro = new IM253E06Libro();
        var connection = new SqlConnection(_connectionString);
        var command = new SqlCommand("SELECT [Id],[Autor],[Editorial],[ISBN],[Foto] FROM IM253E06Libro WHERE Id = @Id", connection);
    ...
    public void Create(IM253E06Libro data)
    {
        var connection = new SqlConnection(_connectionString);
        var command = new SqlCommand("INSERT INTO IM253E06Libro (Id, Autor, Editorial, ISBN, Foto) VALUES (@Id, @Autor, @Editorial, @ISBN, @Foto)", connection);
    ...
    public void Edit(IM253E06Libro data)
    {
        var connection = new SqlConnection(_connectionString);
        var command = new SqlCommand("UPDATE IM253E06Libro SET Autor = @Autor, Editorial = @Editorial, ISBN = @ISBN, Foto = @Foto WHERE Id = @Id", connection);
    ...
    {
        var connection = new SqlConnection(_connectionString);
        var command = new SqlCommand("DELETE FROM IM253E06Libro WHERE Id = @Id", connection);
        command.Parameters.Add(new SqlParameter("@Id", id));
