...
public class UsuariosDbContext
{
    ...
    public List<IM253E06Usuario> List()
    {
        var usuarios = new List<IM253E06Usuario>();
        var connection = new SqlConnection(_connectionString);
        var command = new SqlCommand("SELECT [Id], [Nombre], [Direccion], [Telefono], [Correo] FROM IM253E06Usuario", connection);
        try
        {
            connection.Open();
            ...
            while (reader.Read())
            {
                usuarios.Add(new IM253E06Usuario
                {
                    Id = reader.GetGuid(0),
    ...
    public IM253E06Usuario Details(Guid id)
    {
        var usuario = new IM253E06Usuario();
        var connection = new SqlConnection(_connectionString);
        var command = new SqlCommand("SELECT [Id], [Nombre], [Direccion], [Telefono], [Correo] FROM IM253E06Usuario WHERE Id = @Id", connection);
    ...
    public void Create(IM253E06Usuario data)
    {
        var connection = new SqlConnection(_connectionString);
        var command = new SqlCommand(
            "INSERT INTO IM253E06Usuario (Id, Nombre, Direccion, Telefono, Correo) VALUES (@Id, @Nombre, @Direccion, @Telefono, @Correo)", connection);
    ...
    public void Edit(IM253E06Usuario data)
    {
        var connection = new SqlConnection(_connectionString);
        var command = new SqlCommand(
            "UPDATE IM253E06Usuario SET Nombre = @Nombre, Direccion = @Direccion, Telefono = @Telefono, Correo = @Correo WHERE Id = @Id", connection);
    ...
    {
        var connection = new SqlConnection(_connectionString);
        var command = new SqlCommand("DELETE FROM IM253E06Usuario WHERE Id = @Id", connection);
        command.Parameters.Add(new SqlParameter("@Id", id));
