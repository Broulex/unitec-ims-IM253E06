...
public class PrestamosDbContext
{
    ...
    public List<IM253E06Prestamo> List()
    {
        var prestamos = new List<IM253E06Prestamo>();
        var connection = new SqlConnection(_connectionString);
        var command = new SqlCommand(
            "SELECT Id, UsuarioId, LibroId, FechaPrestamo, FechaDevolucion FROM IM253E06Prestamos",
            connection);
        ...
        try
        {
            ...
            while (reader.Read())
            {
                prestamos.Add(new IM253E06Prestamo
                {
                    Id = reader.GetGuid(0),
    ...
    public IM253E06Prestamo Details(Guid id)
    {
        var prestamo = new IM253E06Prestamo();
        var connection = new SqlConnection(_connectionString);
        var command = new SqlCommand(
            "SELECT Id, UsuarioId, LibroId, FechaPrestamo, FechaDevolucion FROM IM253E06Prestamos WHERE Id = @Id",
            connection);
    ...
    public void Create(IM253E06Prestamo data)
    {
        var connection = new SqlConnection(_connectionString);
        var command = new SqlCommand(
            "INSERT INTO IM253E06Prestamos (Id, UsuarioId, LibroId, FechaPrestamo, FechaDevolucion) " +
    ...
    public void Edit(IM253E06Prestamo data)
    {
        var connection = new SqlConnection(_connectionString);
        var command = new SqlCommand(
            "UPDATE IM253E06Prestamos SET UsuarioId = @UsuarioId, LibroId = @LibroId, FechaPrestamo = @FechaPrestamo, FechaDevolucion = @FechaDevolucion WHERE Id = @Id",
            connection);
    ...
    {
        var connection = new SqlConnection(_connectionString);
        var command = new SqlCommand("DELETE FROM IM253E06Prestamos WHERE Id = @Id", connection);
        command.Parameters.Add(new SqlParameter("@Id", id));
