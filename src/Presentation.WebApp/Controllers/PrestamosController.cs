...
namespace Presentation.WebApp.Controllers
{
    public class PrestamosController : Controller
    {
        ...
        [HttpPost]
        public IActionResult Create(IM253E06Prestamo data)
        {
        ...
        [HttpPost]
        public IActionResult Edit(IM253E06Prestamo data)
        {
            if (!ModelState.IsValid)
            {
                PopulateSelectLists(data);
        ...
        private void PopulateSelectLists(IM253E06Prestamo? prestamo = null)
        {
